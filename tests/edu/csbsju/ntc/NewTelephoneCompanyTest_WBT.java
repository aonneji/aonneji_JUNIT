...
public class NewTelephoneCompanyTest_WBT {
	private NewTelephoneCompany ntc;
			...
			public void testGetStartTime() {
		        ...
		        assertEquals("Starttime is " + expResult,expResult, result);
			}
		...
		@Test
		public void testComputeCharge_DiscountedStartTimeAndDiscountedDurantion_() {
		...
		@Test
		public void testComputeCharge_DiscountedStartTime_() {
			ntc.setStartTime(0);
			ntc.setDuration(60);
		...
		@Test
		public void testComputeCharge_DiscountedDuration_() {
		...
		@Test
		public void testComputeCharge_NoDiscount_() {
